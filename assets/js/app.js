...
$(document).ready(function () {
  ...
  function show() {
    $(".main-ctn-bigTitle, .main-ctn-burger, .main-ctn-dropdown ").addClass(
      "show"
    );
  }
});
...
$(document).ready(function () {
  $(
    ".main-ctn-dropdown, .menu-link-1, .menu-link-2, .menu-link-3, .menu-link-4, .menu-link-5"
  ).on("click", function () {
...
$(document).ready(function () {
  $(".ctn-skills-ctn-triangle").waypoint(
    function (direction) {
  ...
  $(".about-ctn-big-ctn-bio").waypoint(
    function (direction) {
      if (direction == "down") {
  ...
  $(".about-ctn-big-ctn-assets").waypoint(
    function (direction) {
      if (direction == "down") {
...
$(document).ready(function () {
  $(".career-ctn-center-gallery-wrap").on(
    "click",
    "div.career-btn-reponsive",
    function () {
      $(this)
        .siblings(".item-ctn-title")
        .toggleClass("item-ctn-title-hide-reponsive");
      $(this).parents(".item").toggleClass("item-show-responsive");
      $(this)
        .siblings(".item-ctn-desc")
        .toggleClass("item-ctn-desc-show-responsive");
